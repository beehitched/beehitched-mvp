      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Moodboard Inspiration</h2>
                <Image className="w-6 h-6 text-pink-600" />
              </div>
              
              <div className="text-center py-8">
                <Image className="w-12 h-12 text-pink-400 mx-auto mb-4" />
                <h3 className="text-lg font-medium text-gray-900 mb-2">Start Your Visual Journey</h3>
                <p className="text-gray-600 mb-6">
                  Collect and organize inspiration images for your perfect wedding day
                </p>
                <Link 
                  href="/moodboard"
                  className="bg-pink-500 hover:bg-pink-600 text-white px-6 py-3 rounded-lg font-medium transition-colors inline-flex items-center gap-2"
                >
