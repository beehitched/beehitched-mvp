      ...
      >
        ...
        >
          <div className="text-center p-4">
            ...
            <h3 className="font-semibold text-gray-900 mb-1">Timeline Planning</h3>
            <p className="text-sm text-gray-600">Organize tasks and deadlines</p>
          </div>
          ...
          <div className="text-center p-4">
            ...
            <p className="text-sm text-gray-600">Track RSVPs and guest details</p>
          </div>
